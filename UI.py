...
"""
def on_enter(e):
    style.configure("Custom.TButton", bordercolor="red") 

def on_leave(e):
    style.configure("Custom.TButton", bordercolor="black")  
"""
...
btn2.bind('<Enter>', lambda e: btn2.configure(text="Hover!"))
btn2.bind('<Leave>', lambda e: btn2.configure(text="Language"))
